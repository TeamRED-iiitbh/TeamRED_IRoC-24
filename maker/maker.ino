// // Define pin numbers
// const int stepPin = A0;   // Step pin
// const int dirPin = A1;    // Direction pin
// const int enPin = 38;     // Enable pin
...
//   // Set enable pin LOW to enable the stepper motor
...
//   // Send message when rotation is completed
